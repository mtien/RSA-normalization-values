...
points(Over$Phi*180/pi, Over$Psi*180/pi, pch=21, col=rcol2, bg=red, cex=1.5)
mtext(expression(psi), side=2, line=4.5, outer= FALSE, las=1, cex=2.75)
mtext(expression(phi), side=1, line=4.5, outer=FALSE, cex=2.75)

legend("topright", c("RSA < 1", "RSA > 1"), bg=rgb(1,1,1), cex=2.75, col=c(rcol,red), pch=c(16,16), box.lwd = 1)
