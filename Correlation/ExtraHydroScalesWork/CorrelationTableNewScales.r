...
Correlations<- data.frame(labels=labels, radzCorr= radzCorr, radzPval=radzPval, moonCorr= moonCorr, moonPval=radzPval, macCorr= radzCorr, macPval=radzPval, wimCorr=wimCorr, wimPval=wimPval, fauCorr=fauCorr, fauPval=fauPval)
