...
def getSA(structure, AA, num):
    ft="temp" + AA+ str(num) +".pdb"
    w= PDBIO()
...
def changeRotamers(geoGly1, geoXX, geoGly2):
    ...
    if(AA in Rotamer_Variance_1):
        for i in rotamers:
            ...
            if(checkTripeptide):
                acc_list.append( getSA(structure, AA,i))
            else:
                acc_list.append(0)
        ...
        if(AA in Rotamer_Variance_Branched):
            for i in rotamers:
                ...
                for j in rotamers2:
                    ...
                    structure= makeTripeptide(geoGly1, geoXX, geoGly2)
                    if(checkTripeptide):
                        acc_list.append( getSA(structure, AA, (i*100)+j ))
                    else:
                        acc_list.append(0)
        else:
            for i in rotamers:
        ...
        if(AA =="I"):
            for i in range(0,10):
                ...
                structure= makeTripeptide(geoGly1, geoXX, geoGly2)
                if(checkTripeptide):
                    acc_list.append(getSA(structure, AA, rotamer_1*10000+ rotamer_2*100+ rotamer_3 ))
                else:
                    acc_list.append(0)
